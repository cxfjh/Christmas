<template>
    <div>
        <svg class="mainSVG" viewBox="0 0 800 600" id="svg" ref="mainSVG">
            <defs>
                ...
                <mask id="treePathMask">
                    <path class="treePathMask" fill="none" stroke-width="18" stroke="#FFF"
                        d="M252.9,447.9c0,0-30.8-21.6,33.9-44.7c64.7-23.1,46.2-37,33.9-41.6 c-12.3-4.6-59.3-11.6-42.4-28.5s114-52.4,81.7-66.2c-32.4-13.9-58.5-10.8-35.4-29.3s66.2-101.7,70.9-115.6 c4.4-13.2,16.9-18.5,24.7,0c7.7,18.5,44.7,100.1,67.8,115.6c23.1,15.4-10.8,21.6-26.2,24.7c-15.4,3.1-20,33.9,33.9,49.3c53.9,15.4,47.8,40.1,27.7,44.7c-20,4.6-63.2,4.6-27.7,32.4s98.6,21.6,61.6,60.1" />
                </mask>
...
<script setup>
import { backgroundImg } from '../assets/Image.js';
import { ref } from 'vue';
const mainSVG = ref(null);

const script = document.createElement('script');
script.src = './ChristmasTreeJS/index.js';
document.head.appendChild(script);

const transition = () => {
    setTimeout(() => {
        mainSVG.value.style.transition = '3.5s ease-in-out';
        mainSVG.value.style.transform = 'translate(-50%, -50%) scale(1.5)';
    }, 100);
    setTimeout(() => {
        mainSVG.value.style.transition = '0s ease-in-out';
        mainSVG.value.style.background = `url('${backgroundImg}')`;
        mainSVG.value.style.backgroundSize = 'auto 0%';
        mainSVG.value.style.backgroundRepeat = 'no-repeat';
        mainSVG.value.style.backgroundPosition = 'center top';
    }, 4000)
};

const changeBackground = () => {
    mainSVG.value.style.transition = '1s ease-in-out';
    mainSVG.value.style.backgroundSize = 'auto 100%';
    mainSVG.value.style.backgroundRepeat = 'no-repeat';
};

defineExpose({ transition, changeBackground });
</script>
